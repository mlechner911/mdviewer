...
### Windows
- Download `marksafe-1.3.0-windows-setup.exe` and run the installer.

### macOS
- Download `marksafe-mac.zip`, extract, and move `MarkSafe.app` to your `/Applications` folder.

### Linux
- Download `marksafe-1.3.0-linux-amd64`.
- Make it executable: `chmod +x marksafe-1.3.0-linux-amd64`.
- Run `./marksafe-1.3.0-linux-amd64` or add it to your `$PATH`.
